drop table AM_CONTACT IF EXISTS CASCADE;
drop table AUCTION IF EXISTS CASCADE;
drop table BET IF EXISTS CASCADE;
drop table BUYER_CONTACT IF EXISTS CASCADE;
drop table IMAGE IF EXISTS CASCADE;
create table AM_CONTACT (AUCTION_ID bigint not null, BANK varchar(255), BANK_ACCOUNT_NB varchar(32), EMAIL varchar(255), LOGIN varchar(255), NAME varchar(255), PHONE varchar(255), SURNAME varchar(255), primary key (AUCTION_ID));
