...
public class TestDataGenerator {
    ...
    public static void main(String [] args) {
        ...
        try {
            ...
            // auctions
            sqls.add("INSERT INTO AUCTION (" + AuctionColumns + ") VALUES (1, 'AM', 25, 'Odbiór osobisty', 'Nieużywany kaftan bezpieczeństwa. Z gwarancją. Wszytkie metki zgodne.', CURRENT_TIMESTAMP + 4 DAY, CURRENT_TIMESTAMP - 1 DAY, 10, 'Super kaftan bezpieczeństwa', 0, 0 , 0)");
            sqls.add("INSERT INTO AUCTION (" + AuctionColumns + ") VALUES (2, 'AM', 13430, 'Odbiór osobisty', 'Na sprzedaż samochód marki BentLej. Pochodzi z floty przedstawicieli handlowych wydziału do spraw wali z zombie', CURRENT_TIMESTAMP + 5 DAY + 4 HOUR, CURRENT_TIMESTAMP - 17 HOUR, 10000, 'Najnowszy BentLej', 0, 0 , 0)");
            sqls.add("INSERT INTO AUCTION (" + AuctionColumns + ") VALUES (3, 'AM', 500, 'Przesyłka kurierska', 'Najnowszy NEXUS 5, pełna gwarancja, wszystko cacy.', CURRENT_TIMESTAMP + 5 DAY + 4 HOUR, CURRENT_TIMESTAMP - 1 DAY - 13 HOUR, 100, 'Najnowszy BentLej', 0, 0 , 0)");
            sqls.add("INSERT INTO AUCTION (" + AuctionColumns + ") VALUES (4, 'AM', 240, 'Paczkomat', 'Zegarek rolmex. Zniszczony i niesprawny', CURRENT_TIMESTAMP + 7 DAY + 16 HOUR, CURRENT_TIMESTAMP - 2 DAY + 7 HOUR, 200, 'Super ROLMEX!', 0, 0 , 0)");
            // todo: verify finalized/finished/won flags
            sqls.add("INSERT INTO AUCTION (" + AuctionColumns + ") VALUES (5, 'AM', 2.5, 'Odbiór osobisty', '1 kg mandarynek, w sam raz na prezent!', CURRENT_TIMESTAMP - 1 HOUR, CURRENT_TIMESTAMP - 10 DAY, 1, 'Kilogram mandarynek', 0, 1 , 1)");

            // contact details for aucton managers
            sqls.add("INSERT INTO AM_CONTACT (" + AMContactColumns + ") VALUES (1, 'PEKA�?O BPSA', '65102056980000598645620125', 'AMUser@testmail.com', 'AM', 'AMUser', '854321886', 'am')");
            sqls.add("INSERT INTO AM_CONTACT (" + AMContactColumns + ") VALUES (2, 'BZWmBank', '65102056980000748645620123', 'AMUser@testmail.com', 'AM', 'AMUser', '854321886', 'am')");
            sqls.add("INSERT INTO AM_CONTACT (" + AMContactColumns + ") VALUES (3, 'InteMilenium', '66202056980000748325628877', 'AMUser@testmail.com', 'AM', 'AMUser', '854321886', 'am')");
            sqls.add("INSERT INTO AM_CONTACT (" + AMContactColumns + ") VALUES (4, 'IMG M. Kondrad sp. Zuoo', '65805056630000713447521123', 'AMUser@testmail.com', 'AM', 'AMUser', '854321886', 'am')");
            sqls.add("INSERT INTO AM_CONTACT (" + AMContactColumns + ") VALUES (5, 'BZWmBank', '65102056980000748645620123', 'amuser@testmail.com', 'AM', 'AMUser', '854321886', 'am')");

            // buyer contact
            sqls.add("INSERT INTO BUYER_CONTACT (" + BuyerContactColumns + ") VALUES (5, 'ul. Fioletowa 18, 73-158 Wozitkowo Dolne', 'client@testmail.com', 'client', 'Client', '447529862', 'Kupujący')");
            ...
            // test inserts....
            resultSet = statement
                    .executeQuery("SELECT * FROM AUCTION");
